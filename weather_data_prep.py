...
def InstantiateModel():
    ...
    m.years = ['1992', '1993', '1999'] #[str(y) for y in range(2005,2020)]
    ...
    m.windturbine_onshore = atlite.windturbines.Vestas_V112_3MW

    m.data_path = "D:/ProjectData/Weather data/ERA5 China/"

    #m.potential_file = m.region_file
    #m.potential = gpd.read_file(m.potential_file)[m.region['name']==m.admin]
